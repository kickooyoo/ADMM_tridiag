function [xMFIS, CMFIS, TFIS, l2DFIS, RMSEFIS] = MFISTA_wrapper(Nx, Ny, R, y, xinit, D, lambda, niter, curr_folder, MFISTA_mod_str, varargin)
%function [xMFIS, CMFIS, TFIS, l2DFIS, RMSEFIS] = MFISTA_wrapper(Nx, Ny, R, y, xinit, D, lambda, niter, curr_folder, MFISTA_mod_str, varargin)
% 
% wrapper for MFISTA for getting x_inf for tridiagonal ADMM
	...
	mEAWA_fname = [curr_folder '/' MFISTA_mod_str 'mEAWA_MFISTA.mat'];
