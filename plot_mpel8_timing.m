%load(sprintf('./reviv/mpel8_timing_%dx%d_%diter_testhalfbeta.mat', Nx, Ny, niter), 'time_tri', 'time_tri_max', 'time_alp2c', 'time_tri_2max', 'nrmsd_tri', 'nrmsd_tri_max', 'nrmsd_alp2c', 'nrmsd_tri_2max')
if ~isvar('time_tri')
truncate = 0;
...
load(sprintf('./reviv/mpel8_timing_%dx%d_%diter_tunedmu.mat', Nx, Ny, niters));
end
