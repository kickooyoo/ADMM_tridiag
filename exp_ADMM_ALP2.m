...
%end
[xhat_alp2, ~, nrmsd_alp2, costOrig_alp2, time_alp2] = AL_P2_gen(y_noise, F, S, R, xinit, niters, beta, xtrue,'inner_iter', 1);
if issim
	mu_args = {'noise', 2};
else
	mu_args = {};
...
[xhat_tri, ~, nrmsd_tri, costOrig_tri, time_tri] = ADMM_tridiag(y_noise, F, S, CH, CV, beta, xinit, xtrue, niters, 'mu_args', mu_args);
[xhat_AL, ~, nrmsd_AL, costOrig_AL, time_AL] = AL_tridiag(y_noise, F, S, CH, CV, beta, xinit, xtrue, niters, 'mu_args', mu_args);
[xhat_ALsm, ~, nrmsd_ALsm, costOrig_ALsm, time_ALsm] = AL_tridiag(y_noise, F, S, CH, CV, beta, xinit, xtrue, niters, 'mu_args', [mu_args {'fancy_mu34', false}]);
