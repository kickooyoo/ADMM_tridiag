...
[xhat_tri, ~, nrmsd_tri, costOrig_tri, time_tri] = tridiag_ADMM_W(...
...
for ii = 1:3
        [xhat_alp2c, ~, nrmsd_alp2c, costOrig_alp2c, time_alp2c] = AL_P2_gen(...
                y_noise, F, S, Rcirc, SoS, niters, beta, x_alp2c_inf, 'mu', mu, 'zmethod','fft', 'inner_iter', ii);
        [xhat_alp2t, ~, nrmsd_alp2t, costOrig_alp2t, time_alp2t] = AL_P2_gen(y, F, S, R, SoS, niters, beta, x_tri_inf, 'mu', mu,'inner_iter', ii);
        save(sprintf('./reviv/mpel8_timing_alp2_%dx%d_%ii.mat', Nx, Ny, ii),'xhat_alp2c','nrmsd_alp2c','time_alp2c', 'xhat_alp2t', 'nrmsd_alp2t', 'time_alp2t', 'ii');
end
