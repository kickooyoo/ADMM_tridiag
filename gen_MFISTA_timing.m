...
save(sprintf('./reviv/curr/%s_x_MFISTA_timing_%s_beta%.*d.mat', machine(1:3), slice_str, 3, beta), 'xMFIS', 'niters', 'costOrig_MFIS', 'time_MFIS', 'nrmsd_MFIS');
