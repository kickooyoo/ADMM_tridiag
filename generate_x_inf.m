...
if do_tri
	[xhat_tri_inf, ~, nrmsd_tri_inf, costOrig_tri_inf, time_tri_inf] = ADMM_tridiag(y_noise, F, S, CH, CV, beta, xinit, zeros(size(SoS)), niters_inf, 'save_progress', 'tridiag_xinf');
	save(sprintf('%s/x_tri_inf_%s_beta%.*d.mat', curr_folder, slice_str, 3, beta), 'x_tri_inf', 'nrmsd_tri_inf', 'costOrig_tri_inf', 'time_tri_inf', 'niters_inf');
end
if do_circ
