function [x, xsaved, err, cost, time] = AL_tridiag(y, F, S, CH, CV, ...
...
[subCC, subCCT, diagCC, diagCCT] = construct_Hessian_diags(mu0, mu1, mu3, mu3, Nx, Ny, beta);

if arg.compile_mex
        confirm_compile('tridiag_inv_mex_noni');
end

err(1) = calc_NRMSE_over_mask(x, xtrue, true(arg.mask));
...
for iter = 1:niters
	...
	tridiag_tic = tic;
        u3 = u3_update_mex(mu1, mu2, mu3, arg.alph, eig_SS, CV, S, u1, u2, x, eta1, eta2, eta3, subCCT, diagCCT, arg.nthread);
        x = x_update(mu0, mu2, mu3, arg.alph, eig_SS, CH, S, u0, u2, u3, eta0, eta2, eta3, subCC, diagCC, arg.nthread);
...
function u3 = u3_update_mex(mu1, mu2, mu3, alph, eig_SS, CV, S, u1, u2, x, ...
        eta1, eta2, eta3, subCCT, diagCCT, nthread)
...
function x = x_update(mu0, mu2, mu3, alph, eig_SS, CH, S, u0, u2, u3, ...
        eta0, eta2, eta3, subCC, diagCC, nthread)
