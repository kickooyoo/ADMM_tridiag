...
for ii = 1:2
	...
	[xhat_trit2_40, ~, nrmsd_trit2_40, costOrig_trit2_40, time_trit2_40] = ADMM_tridiag(y_noise, ...
		F, S, CH, CV, beta, xinit, x_tri_inf, niters, 'mask', mask, 'fancy_mu34', 1, 'nthread', int32(40));

%	[xhat_tri, ~, nrmsd_tri, costOrig_tri, time_tri] = ADMM_tridiag(y_noise, ...
...
%	[xhat_trit2p, ~, nrmsd_trit2p, costOrig_trit2p, time_trit2p] = ADMM_tridiag(y_noise, ...
